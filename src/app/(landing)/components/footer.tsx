		...
		<footer className="bg-gray-900 text-gray-300">
			<div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
				<div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12">
					<div className="col-span-2 md:col-span-4 lg:col-span-1">
						...
						<p className="text-sm text-gray-400 mb-6">
							Sistema completo de gestão de vendas com inteligência artificial
							para pequenos e médios negócios.
						</p>
						<div className="flex gap-4">
							<a
								href="https://instagram.com/vendinhas.app"
								target="_blank"
							...
							<a
								href="https://linkedin.com/company/vendinhas"
								target="_blank"
								rel="noopener noreferrer"
								className="text-gray-400 hover:text-white transition-colors"
								aria-label="LinkedIn"
							...
							<a
								href="https://youtube.com/@vendinhas"
								target="_blank"
								rel="noopener noreferrer"
								className="text-gray-400 hover:text-white transition-colors"
								aria-label="YouTube"
				...
				<div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
					...
					<p className="text-sm text-gray-400">
						Feito com 💜 por quem vende como você
					</p>
				</div>
			</div>
		</footer>
