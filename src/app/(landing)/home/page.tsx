    ...
    <section id="features" className="py-24 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Ferramentas poderosas e fáceis de usar para gerenciar todo o seu negócio
          </motion.p>
        </motion.div>
...
const steps = [
  {
    ...
    description: "Cadastro rápido e gratuito. Comece a usar em menos de 2 minutos.",
  },
  {
    icon: Layers,
    title: "Configure seu negócio",
    description: "Adicione seus produtos, categorias e personalize conforme sua necessidade.",
  },
  {
    icon: TrendingUp,
    title: "Venda e cresça",
    description: "Registre vendas, acompanhe métricas e tome decisões inteligentes.",
  },
];
...
function AISection() {
  return (
    <section id="ai" className="py-24 bg-gradient-to-br from-indigo-900 via-purple-900 to-indigo-900 relative overflow-hidden">
                  ...
                  <li key={feature} className="flex items-center gap-3">
                    <CheckCircle2
                      className={cn(
                        ...
                        plan.highlighted ? "text-yellow-300" : "text-indigo-600"
                      )}
                    />
                    <span
                      className={cn(
    ...
    <section className="py-24 bg-gradient-to-r from-indigo-600 to-purple-600">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Junte-se a mais de 500 empresas que já estão vendendo mais com o Vendinhas.
          </motion.p>
          <motion.div variants={fadeInUp}>
            <Link
              href="/register"
