					...
					<div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8 md:p-12">
						...
						<div className="prose prose-gray dark:prose-invert max-w-none">
							<p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
								...
								a gerenciarem <strong>vendas</strong>, <strong>estoque</strong>{" "}
								e <strong>pedidos</strong> de forma simples e eficiente. Ao
								acessar ou usar o <strong>Vendinhas.app</strong>, você concorda
							...
							<p className="text-gray-600 dark:text-gray-300">
								...
								<strong>Vendinhas.app</strong>. Ao se registrar, você declara
								que atende a esses requisitos.
							</p>
							...
							<p className="text-gray-600 dark:text-gray-300">
								...
								durante o registro.{" "}
								<strong>Mantenha sua senha confidencial</strong> e notifique-nos
								imediatamente sobre qualquer <strong>uso não autorizado</strong>{" "}
								de sua conta. Nós nos reservamos o direito de{" "}
							...
							<ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2 mb-4">
								...
								<li>
									...
									<strong>custos operacionais</strong> e{" "}
									<strong>relatórios</strong> relacionados.
								</li>
							</ul>
							<p className="text-gray-600 dark:text-gray-300 mb-4">
							...
							<p className="text-gray-600 dark:text-gray-300">
								...
								<strong>licença limitada, não exclusiva e revogável</strong>{" "}
								para usar o serviço para fins pessoais ou comerciais
								relacionados ao seu negócio de consultoria.{" "}
								<strong>
							...
							<p className="text-gray-600 dark:text-gray-300">
								...
								violar estes Termos ou por qualquer outro motivo. Ao encerrar
								sua conta, você <strong>perderá acesso aos dados</strong>{" "}
								armazenados na plataforma. Recomendamos que{" "}
							...
							<p className="text-gray-600 dark:text-gray-300">
								O Vendinhas.app é fornecido{" "}
								<strong>&quot;como está&quot;</strong>, sem garantias de
								qualquer tipo, expressas ou implícitas, incluindo precisão,
								disponibilidade ou adequação para um propósito específico.{" "}
								<strong>Não garantimos</strong> que o serviço esteja livre de
							...
							<p className="text-gray-600 dark:text-gray-300">
								...
								<strong>responsabilidade total não excederá</strong> o valor
								pago por você nos últimos <strong>12 meses</strong>.
							</p>
