          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8 md:p-12">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                ...
                <strong>compartilhamos</strong> e <strong>protegemos</strong> suas
                informações ao usar nosso aplicativo web para gerenciamento de
                vendas e estoque. Ao usar o <strong>Vendinhas.app</strong>, você
                consente com as práticas descritas aqui.
              </p>
              ...
              <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-3 mb-4">
                <li>
                  ...
                  endereço, dados de pagamento e detalhes de contato ao criar uma
                  conta.
                </li>
                <li>
              ...
              <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2">
                <li>
                  Fornecer e melhorar o <strong>Vendinhas.app</strong>, incluindo
                  verificação de estoque, cadastro de pedidos e relatórios de
                  vendas.
                </li>
                <li>
                  Enviar <strong>notificações</strong> sobre atualizações, pedidos
                  ou alertas de estoque.
                </li>
                <li>
              ...
              <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2">
                ...
                <li>
                  Em caso de <strong>fusão ou aquisição</strong>, com o comprador.
                </li>
              </ul>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Seus dados são armazenados em <strong>servidores seguros</strong>{" "}
                usando <strong>PostgreSQL</strong> e infraestrutura{" "}
                <strong>Docker</strong>. Implementamos medidas de segurança, como{" "}
                <strong>criptografia</strong> e{" "}
                <strong>controles de acesso</strong>, para proteger contra acessos
                não autorizados. No entanto,{" "}
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">Você pode:</p>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                ...
                <strong>LGPD</strong> (Lei Geral de Proteção de Dados Pessoais) no
                Brasil.
              </p>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Retemos dados enquanto sua conta estiver <strong>ativa</strong> ou
                conforme necessário para fins legais. Após exclusão, podemos reter{" "}
                <strong>backups</strong> por até <strong>90 dias</strong>.
              </p>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                ...
                sobre mudanças significativas via <strong>e-mail</strong> ou no
                app. O uso continuado constitui <strong>aceitação</strong>.
              </p>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Para dúvidas ou reclamações sobre privacidade, entre em contato em{" "}
                <a
                  href="mailto:privacidade@vendinhas.app"
                  className="text-indigo-600 dark:text-indigo-400 hover:underline"
                >
